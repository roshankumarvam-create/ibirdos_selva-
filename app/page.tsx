  ...
  return (
    <div style={{ fontFamily: 'Inter, Arial, sans-serif', background: '#F8FAFC', minHeight: '100vh', color: '#0F172A' }}>
      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ fontSize: '14px', color: '#93C5FD', marginTop: '6px', marginBottom: 0 }}>
        ...
        >
          ...
          <span style={{ fontSize: '13px', color: '#6EE7B7' }}>
            Diwali special drove +22% revenue this week. Re-run Tamil Nadu Feast bundle next Friday. FDA alert:
            Romaine recall — check Sysco INV-2891.
          </span>
        </div>
      </div>
      ...
      <div style={{ padding: '28px 32px' }}>
        ...
        >
          <div style={{ fontSize: '14px', fontWeight: 600, color: '#0F172A', marginBottom: '14px' }}>Quick Actions</div>
        ...
        >
          ...
          >
            ...
            >
              <h3 style={{ fontSize: '15px', fontWeight: 600, color: '#0F172A', margin: 0 }}>Daily Sales — This Week</h3>
